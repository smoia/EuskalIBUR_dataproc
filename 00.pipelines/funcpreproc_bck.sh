...
##
	...
	then
		...
		do
			...
			bold=${flpr}_task-${f}_echo-${e}_bold
			02.func_preproc/07.func_nuiscomp.sh ${bold}_bet ${fmat} ${anat1} ${anat2} ${sbrf} ${fdir} ${adir} none
			...
			02.func_preproc/08.func_smooth.sh ${bold}_bet ${fdir} ${fwhm} ${mask}
			...
			02.func_preproc/09.func_spc.sh ${bold}_sm ${fdir}
		...
		02.func_preproc/07.func_nuiscomp.sh ${bold}_bet ${fmat} ${anat1} ${anat2} ${sbrf} ${fdir} ${adir} 0
