...
for ftype in optcom meica-orth  # meica-aggr meica-cons meica-mvar echo-2  # optcom meica-aggr meica-orth meica-cons meica-mvar echo-2  # meica-recn vessels-preg
do
	echo "************************************"
