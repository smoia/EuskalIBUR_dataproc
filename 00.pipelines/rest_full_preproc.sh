...
do
	...
	echo "mv ${tmp}/${bold}_den.nii.gz ${tmp}/${bold}_denmeica.nii.gz"
	mv ${tmp}/${bold}_den.nii.gz ${tmp}/${bold}_denmeica.nii.gz
	...
	echo "mv ${tmp}/${bold}_tpp.nii.gz ${tmp}/${bold}_tppmeica.nii.gz"
	mv ${tmp}/${bold}_tpp.nii.gz ${tmp}/${bold}_tppmeica.nii.gz
	...
	echo "mv ${tmp}/${bold}_sm.nii.gz ${tmp}/${bold}_smmeica.nii.gz"
	mv ${tmp}/${bold}_sm.nii.gz ${tmp}/${bold}_smmeica.nii.gz
	...
	# echo "mv ${tmp}/${bold}_SPC.nii.gz ${fdir}/03.${bold}_native_meica_SPC_preprocessed.nii.gz"
	# mv ${tmp}/${bold}_SPC.nii.gz ${fdir}/03.${bold}_native_meica_SPC_preprocessed.nii.gz
	# ${sdr}/02.func_preproc/09.func_spc.sh ${bold}_sm ${fdir} ${tmp}

	# # Rename output
	# echo "mv ${tmp}/${bold}_SPC.nii.gz ${fdir}/01.${bold}_native_SPC_preprocessed.nii.gz"
	# mv ${tmp}/${bold}_SPC.nii.gz ${fdir}/01.${bold}_native_SPC_preprocessed.nii.gz
