...
if [ -d tmp.${flpr}_${ftype}_02cmi_res ]
then
	rm -rf tmp.${flpr}_${ftype}_02cmi_res
fi
mkdir tmp.${flpr}_${ftype}_02cmi_res
# mkdir tmp.${flpr}_${ftype}_02cmi_res_reml

3dTproject -input ${func}.nii.gz -prefix tmp.${flpr}_${ftype}_02cmi_res/func_demot.nii.gz \
		   -ort ${flpr}_motpar_demean.par -ort ${flpr}_motpar_deriv1.par \
		   -mask ${mask}.nii.gz -polort 3
...
do
	...
	then
		...
		then
			...
			-rout -tout \
			-bucket tmp.${flpr}_${ftype}_02cmi_res/stats_${i}.nii.gz
		fi

		3dbucket -prefix tmp.${flpr}_${ftype}_02cmi_res/${flpr}_${ftype}_r2_${i}.nii.gz -abuc tmp.${flpr}_${ftype}_02cmi_res/stats_${i}.nii.gz'[0]' -overwrite
		3dbucket -prefix tmp.${flpr}_${ftype}_02cmi_res/${flpr}_${ftype}_betas_${i}.nii.gz -abuc tmp.${flpr}_${ftype}_02cmi_res/stats_${i}.nii.gz'[2]' -overwrite
		3dbucket -prefix tmp.${flpr}_${ftype}_02cmi_res/${flpr}_${ftype}_tstat_${i}.nii.gz -abuc tmp.${flpr}_${ftype}_02cmi_res/stats_${i}.nii.gz'[3]' -overwrite

		# 3dREMLfit -matrix ${shiftdir}/${i}_uncensored_mat.1D \
		# -input ${flpr}_${ftype}_SPC.nii.gz -nobout \
		# -mask ${mask}.nii.gz \
		# -Rbuck tmp.${flpr}_${ftype}_02cmi_res_reml/stats_REML_${i}.nii.gz \
		# -Rfitts tmp.${flpr}_${ftype}_02cmi_res_reml/fitts_REML_${i}.nii.gz \
		# -verb -overwrite

		# -Rvar tmp.${flpr}_${ftype}_02cmi_res/stats_REMLvar_${i}.nii.gz \

		# 3dbucket -prefix tmp.${flpr}_${ftype}_02cmi_res_reml/${flpr}_${ftype}_${i}.nii.gz -abuc tmp.${flpr}_${ftype}_02cmi_res_reml/stats_REML_${i}.nii.gz'[1]' -overwrite
	fi
done

fslmerge -tr ${flpr}_${ftype}_r2_time tmp.${flpr}_${ftype}_02cmi_res/${flpr}_${ftype}_r2_* ${tr}
fslmerge -tr ${flpr}_${ftype}_betas_time tmp.${flpr}_${ftype}_02cmi_res/${flpr}_${ftype}_betas_* ${tr}
fslmerge -tr ${flpr}_${ftype}_tstat_time tmp.${flpr}_${ftype}_02cmi_res/${flpr}_${ftype}_tstat_* ${tr}
...
do
	let v=i*step
	v=$( printf %04d $v )
	3dcalc -a ${flpr}_${ftype}_spc_over_V.nii.gz -b tmp.${flpr}_${ftype}_02cmi_res/${flpr}_${ftype}_betas_${v}.nii.gz -c ${flpr}_${ftype}_cvr_idx.nii.gz \
	-expr "a+b*equals(c,${i})" -prefix ${flpr}_${ftype}_spc_over_V.nii.gz -overwrite
	3dcalc -a ${flpr}_${ftype}_tmap.nii.gz -b tmp.${flpr}_${ftype}_02cmi_res/${flpr}_${ftype}_tstat_${v}.nii.gz -c ${flpr}_${ftype}_cvr_idx.nii.gz \
...
fslmaths tmp.${flpr}_${ftype}_02cmi_res/${flpr}_${ftype}_betas_0350 -div 71.2 -mul 100 ${flpr}_${ftype}_cvr_simple
...
# do
# 	cd tmp.${flpr}_${ftype}_02cmi_res
...
rm -rf tmp.${flpr}_${ftype}_02cmi_*
