...
do
	...
	run3dLMEr="${run3dLMEr} -gltCode sleep 'sleep :'"
	run3dLMEr="${run3dLMEr} -gltCode exercise 'exercise :'"
	run3dLMEr="${run3dLMEr} -gltCode water 'water :'"
	run3dLMEr="${run3dLMEr} -gltCode coffee 'coffee :'"
	run3dLMEr="${run3dLMEr} -gltCode alcohol 'alcohol :'"
	run3dLMEr="${run3dLMEr} -gltCode systolic 'systolic :'"
	run3dLMEr="${run3dLMEr} -gltCode diastolic 'diastolic :'"
	run3dLMEr="${run3dLMEr} -gltCode pulse 'pulse :'"
	run3dLMEr="${run3dLMEr} -gltCode sex 'sex : 1*m -1*f'"
	run3dLMEr="${run3dLMEr} -gltCode sleep_sex 'sex : 1*m -1*f sleep :'"
	run3dLMEr="${run3dLMEr} -gltCode exercise_sex 'sex : 1*m -1*f exercise :'"
	run3dLMEr="${run3dLMEr} -gltCode water_sex 'sex : 1*m -1*f water :'"
	run3dLMEr="${run3dLMEr} -gltCode coffee_sex 'sex : 1*m -1*f coffee :'"
	run3dLMEr="${run3dLMEr} -gltCode alcohol_sex 'sex : 1*m -1*f alcohol :'"
	run3dLMEr="${run3dLMEr} -gltCode systolic_sex 'sex : 1*m -1*f systolic :'"
	run3dLMEr="${run3dLMEr} -gltCode diastolic_sex 'sex : 1*m -1*f diastolic :'"
	run3dLMEr="${run3dLMEr} -gltCode pulse_sex 'sex : 1*m -1*f pulse :'"
	run3dLMEr="${run3dLMEr} -gltCode sleep_male 'sex : 1*m sleep :'"
	run3dLMEr="${run3dLMEr} -gltCode exercise_male 'sex : 1*m exercise :'"
	run3dLMEr="${run3dLMEr} -gltCode water_male 'sex : 1*m water :'"
	run3dLMEr="${run3dLMEr} -gltCode coffee_male 'sex : 1*m coffee :'"
	run3dLMEr="${run3dLMEr} -gltCode alcohol_male 'sex : 1*m alcohol :'"
	run3dLMEr="${run3dLMEr} -gltCode systolic_male 'sex : 1*m systolic :'"
	run3dLMEr="${run3dLMEr} -gltCode diastolic_male 'sex : 1*m diastolic :'"
	run3dLMEr="${run3dLMEr} -gltCode pulse_male 'sex : 1*m pulse :'"
	run3dLMEr="${run3dLMEr} -gltCode sleep_female 'sex : 1*f sleep :'"
	run3dLMEr="${run3dLMEr} -gltCode exercise_female 'sex : 1*f exercise :'"
	run3dLMEr="${run3dLMEr} -gltCode water_female 'sex : 1*f water :'"
	run3dLMEr="${run3dLMEr} -gltCode coffee_female 'sex : 1*f coffee :'"
	run3dLMEr="${run3dLMEr} -gltCode alcohol_female 'sex : 1*f alcohol :'"
	run3dLMEr="${run3dLMEr} -gltCode systolic_female 'sex : 1*f systolic :'"
	run3dLMEr="${run3dLMEr} -gltCode diastolic_female 'sex : 1*f diastolic :'"
