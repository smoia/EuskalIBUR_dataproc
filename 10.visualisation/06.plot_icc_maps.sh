	...
	do
		...
		do
			...
			fsleyes render -of ICC2_${map}_${ftype}_noclip --size 1400 500 --scene lightbox --displaySpace reg/MNI_T1_brain.nii.gz \
					...
					--resolution 100 --numInnerSteps 10 --volume 0
			convert ICC2_${map}_${ftype}.png -filter Point -resize 1035x370 +repage -crop 920x212+15+70 tmp.06pim/ICC2_${map}_${ftype}_res.png
			convert ICC2_${map}_${ftype}_noclip.png -filter Point -resize 1035x370 +repage -crop 920x212+15+70 tmp.06pim/ICC2_${map}_${ftype}_noclip_res.png
