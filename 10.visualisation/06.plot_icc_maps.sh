...
do
	...
	do
		...
		do
			...
			convert ICC2_${map}_${ftype}.png -filter Point -resize 1035x370 +repage -crop 930x212+5+70 tmp.06pim/ICC2_${map}_${ftype}_res.png
			convert ICC2_${map}_${ftype}_noclip.png -filter Point -resize 1035x370 +repage -crop 930x212+5+70 tmp.06pim/ICC2_${map}_${ftype}_noclip_res.png
		...
		appending_noclip="${appending_noclip} tmp.06pim/ICC2_${map}_noclip_app.png"
		${appending}
		${appending_noclip}
	done
	...
	composite -geometry +1000+0 tmp.06pim/ICC2_lag_${mtype}_noclip_app.png tmp.06pim/ICC2_cvr_${mtype}.png +repage ICC2_${mtype}.png
done
