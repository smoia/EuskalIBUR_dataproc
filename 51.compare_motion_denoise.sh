...
do
	...
	do
		...
		fsl_motion_outliers -i ${wdr}/sub-${sub}/ses-${ses}/00.${flpr}_task-breathhold_optcom_bold_native_preprocessed \
		-o tmp_out -s dvars_optcom_sub-${sub}_ses-${ses}.1D --dvars --nomoco
		fsl_motion_outliers -i ${wdr}/sub-${sub}/ses-${ses}/00.${flpr}_task-breathhold_echo-2_bold_native_preprocessed \
		-o tmp_out -s dvars_echo-2_sub-${sub}_ses-${ses}.1D --dvars --nomoco
		fsl_motion_outliers -i ${wdr}/sub-${sub}/ses-${ses}/${flpr}_task-breathhold_meica_bold_bet \
