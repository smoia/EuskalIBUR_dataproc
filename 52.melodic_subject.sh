...
imcp sub-${sub}/ses-01/func_preproc/00.sub-${sub}_ses-01_task-rest_run-01_optcom_bold_native_preprocessed DMN/sub-${sub}/ses-01_rest_run-01_${ftype}
...
do
	infile=sub-${sub}/ses-${ses}/func_preproc/00.sub-${sub}_ses-${ses}_task-rest_run-01_optcom_bold_native_preprocessed
