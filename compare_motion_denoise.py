...
for sub in sub_list:
    for ses in range(1, 10):
        ...
        for i in range(3):
            ...
            sub_table[delta_col_name] = ( sub_table[col_name] - sub_table[f'{sub}_{ses:02d}_dvars_pre'] ) / sub_table[f'{sub}_{ses:02d}_fd']

            slopes[ses*(i+1)-1] = compute_slope(sub_table[delta_col_name], sub_table[f'{sub}_{ses:02d}_fd'])
    ...
    for i in range(3):
        ...
        sub_table[delta_col_name] = ( sub_table[col_name] - sub_table[f'{sub}_avg_dvars_pre'] ) / sub_table[f'{sub}_avg_fd']
